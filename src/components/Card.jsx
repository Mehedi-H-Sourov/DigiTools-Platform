    ...
    return (
        <div >
            <div className='shadow-lg border-gray-600 rounded-xl p-6 space-y-4'>
                ...
                <button className='btn w-full rounded-full bg-linear-to-r from-blue-600 to-purple-600 text-white' onClick={() => setIsSelected(true)} disabled={isSelected} >
